  ...
  <div class="row">
    <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#" onclick="changePage(5)">Catégories</a>
        </li>
      </ul>
    </nav>
      ...
      <div class="container">
        <div class="containerGroupes">
          ...
          <div class="row">
            ...
            <div class="col-md-7">Association</div>
          </div>
          <!-- Groupe1 -->
          <div class ="row">
            <div class="col-md-1">
        ...
        <div class="containerCharges">
          ...
          <div class ="row">
            ...
            <div class="col-md-9">Charge1</div>
          </div>
          <!-- Charge2 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Charge2</div>
          </div>
          <!-- Charge3 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Charge3</div>
          </div>
          <!-- Charge4 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Charge4</div>
          </div>
          <!-- Charge5 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Charge5</div>
          </div>
          <!-- Charge6 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Charge6</div>
          </div>
          <!-- Charge7 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Charge7</div>
          </div>
        </div>
        <div class="containerInterrupteurs">
          ...
          <div class="row">
            <div class="col-md-1">Statut</div>
            <div class="col-md-2"></div>
            <div class="col-md-9">Interrupteur</div>
          </div>
          <!-- Interrupteur1 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Interrupteur1</div>
          </div>
          <!-- Interrupteur2 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Interrupteur2</div>
          </div>
          <!-- Interrupteur3 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Interrupteur3</div>
          </div>
          <!-- Interrupteur4 -->
          <div class ="row">
            <div class="col-md-1">
            ...
            <div class="col-md-9">Interrupteur4</div>
          </div>
        </div>
        <button type="buttonModifier" class="btn btn-outline-success btn-lg">Modifier</button>
      </div>
