      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="admin_groupe_charges">Groupes<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="admin_interrupteur">Interrupteurs</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="admin_categorie">Catégories</a>
            </li>
          </ul>
        </nav>
          ...
          <div class="container">
            ...
            <div class="container">
              <section class="row text-center placeholders">
                ...
                <div class="col-4 placeholder text-left">
