      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="admin_etat_des_charges">Charges<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
        ...
        <main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
          ...
          <div class="container">
            ...
            <button type="buttonPlanifier" class="btn btn-outline-primary btn-lg btn-block">Planifier</button>
          </div>
        </main>
      </div>
    </div>
